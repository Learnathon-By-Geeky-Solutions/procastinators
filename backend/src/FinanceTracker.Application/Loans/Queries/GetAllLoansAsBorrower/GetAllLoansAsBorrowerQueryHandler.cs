...
public class GetAllLoansAsBorrowerQueryHandler(ILoanRepository loanRepo,
    ...
    IMapper mapper) : IRequestHandler<GetAllLoansAsBorrowerQuery, IEnumerable<LoanDto>>
{
    public async Task<IEnumerable<LoanDto>> Handle(GetAllLoansAsBorrowerQuery request, CancellationToken cancellationToken)
    {
