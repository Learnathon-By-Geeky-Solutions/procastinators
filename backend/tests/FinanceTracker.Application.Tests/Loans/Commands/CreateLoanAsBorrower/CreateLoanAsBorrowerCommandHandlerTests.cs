...
{
    public class CreateLoanCommandAsBorrowerHandlerTests
    {
        private readonly Mock<ILogger<CreateLoanAsBorrowerCommandHandler>> _loggerMock;
        private readonly Mock<IUserContext> _userContextMock;
        private readonly Mock<ILoanRepository> _loanRepositoryMock;
        private readonly Mock<IWalletRepository> _walletRepositoryMock;
        private readonly CreateLoanAsBorrowerCommandHandler _handler;
        private readonly string _userId = "lender-id";
        private readonly int _walletId = 1;

        public CreateLoanCommandAsBorrowerHandlerTests()
        {
            _loggerMock = new Mock<ILogger<CreateLoanAsBorrowerCommandHandler>>();
            _userContextMock = new Mock<IUserContext>();
            _loanRepositoryMock = new Mock<ILoanRepository>();
            _walletRepositoryMock = new Mock<IWalletRepository>();
            _handler = new CreateLoanAsBorrowerCommandHandler(
                _loggerMock.Object,
        ...
        public async Task Handle_ValidRequest_CreatesLoan()
        {
            ...
            var createLoanCommand = new CreateLoanAsBorrowerCommand
            {
                Amount = 1000,
